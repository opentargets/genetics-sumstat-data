...
# Copy to GCS
gsutil -m rsync -r sumstats_raw/ gs://genetics-portal-dev-raw/eqtl_catalogue/210702/sumstats_raw
...
gsutil -m cp gene_counts_Ensembl_96_phenotype_metadata.tsv.gz gs://genetics-portal-dev-raw/eqtl_catalogue/210702/
gsutil -m cp HumanHT-12_V4_Ensembl_96_phenotype_metadata.tsv.gz gs://genetics-portal-dev-raw/eqtl_catalogue/210702/
