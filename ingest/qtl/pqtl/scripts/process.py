...
def main():
    ...
    # args.study_id = 'FOLKERSEN'
    # args.in_nominal = 'example_data/FOLKERSEN/formatted_olinkGWAS_chrALL_pheno*.hm.qc.tsv'
    # args.in_filename_map = 'mappings/folkersen_gene_filename_map.tsv'
    # args.in_gene_map = 'mappings/homo_sapiens_core_104_38_genes.json.gz'
    # args.bio_feature = 'UBERON_0001969'
    # args.out_parquet = 'output/FOLKERSEN.parquet'
    # args.sample_size = 3394
    ...
    #sumstats.limit(20000).toPandas().to_csv('output/FOLKERSEN.100.tsv', sep='\t', index=False)
    ...
    sumstats = (
        sumstats.withColumn('study_id', lit(args.study_id))
            ...
            # Filter based on mac - but not for Hillary dataset, which lacks EAF
