...
def main():
    ...
    # File args (local)
    in_gtex = '/path/to/eqtl_gtex_v8/{tissue}.v8.signif_variant_gene_pairs.txt.gz'
    in_varindex = '/path/to/variant-annotation.parquet'
    in_biofeature_map = '/path/to/biofeature_lut_190328.json'
    out_parquet = 'output/unfiltered/molecular_trait/GTEX_v8.parquet'
    tissues = [
